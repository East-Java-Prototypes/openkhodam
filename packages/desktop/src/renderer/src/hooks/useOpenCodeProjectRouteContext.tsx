...
export function OpenCodeProjectRouteProvider({
  project,
  children
}: {
  ...
  return (
    <OpenCodeProjectRouteContext.Provider value={project}>
      {children}
    </OpenCodeProjectRouteContext.Provider>
  )
}
...
export function useOpenCodeProjectRouteContext(): OpenCodeProjectRouteState {
  ...
  if (!project)
    throw new Error(
      'useOpenCodeProjectRouteContext must be used within an OpenCodeProjectRouteProvider.'
    )
  return project
}
